...
* This project has minimal AI usage, for some boilerplate code and tedious tasks. All AI-generated code is reviewed and edited by me, so it should be up to reasonable standards.
